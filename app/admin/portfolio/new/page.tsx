  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="font-heading text-2xl font-bold text-foreground">New Project</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {success && <div className="rounded-lg bg-emerald-50 dark:bg-emerald-950/50 px-4 py-3 text-sm text-emerald-600 dark:text-emerald-400">Project created! Redirecting...</div>}
